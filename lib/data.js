// Next Energy Solution — Zentrale Datendatei

export const COMPANY = {
  name: "NES",
  fullName: "Next Energy Solution",
...
export const LITHIUM_ADVANTAGES = [
  ...
  },
  {
    ...
    description: "Unterstützt Solar, Wind, Netz und Notstrom — inkl. Microgrid-Fähigkeit (IPower Series).",
    descriptionEn: "Supports solar, wind, grid and emergency power — incl. microgrid capability (IPower Series).",
  },
];
...
export const CONFIG_OPTIONS = {
  ...
  technologies: [
    ...
    { value: "lithium", label: "Lithium-Ionen", labelEn: "Lithium-ion" },
...
export const TEAM = [
  { name: "Attaul Haleem Ahmad", role: "Founder" },
  { name: "A. Musawar Khawaja", role: "Co-Founder" },
  { name: "M. Ahsan Sadiq", role: "Co-Founder" },
  { name: "Patrick Kosek", role: "Co-Founder" },
];
